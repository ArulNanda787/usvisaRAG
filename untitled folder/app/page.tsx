...
const testimonials = [
  { name: "Priya S.", role: "Graduate Student • F-1", text: "Thomas told me exactly which documents I needed. My visa interview lasted 3 minutes. Approved! 🎉", avatar: "👩‍🎓" },
  { name: "Rahul M.", role: "Software Engineer • H-1B", text: "I was completely lost until I found Thomas. Step by step guidance that actually makes sense.", avatar: "👨‍💻" },
  { name: "Ananya K.", role: "Tourist • B-2", text: "Planned my USA trip thanks to Thomas. The DS-160 guide saved me so much confusion!", avatar: "🧳" },
];
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Plus Jakarta Sans', 'Inter', sans-serif" }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-orange-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-orange-500 text-xs font-semibold ml-1 px-2 py-0.5 bg-orange-50 rounded-full border border-orange-200">US Visa HelpBot</span>
          </div>
      ...
      <footer className="py-10 bg-gray-900">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-500 text-sm">© 2025 Thomas. For informational purposes only. Not legal advice.</p>
